...
#include "BS2026SportsCar.h"
#include "BS2026SportsWheelFront.h"
#include "BS2026SportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ABS2026SportsCar::ABS2026SportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UBS2026SportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UBS2026SportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UBS2026SportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UBS2026SportsWheelRear::StaticClass();
