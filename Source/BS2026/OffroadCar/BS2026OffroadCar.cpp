...
#include "BS2026OffroadCar.h"
#include "BS2026OffroadWheelFront.h"
#include "BS2026OffroadWheelRear.h"
...
ABS2026OffroadCar::ABS2026OffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UBS2026OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UBS2026OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UBS2026OffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UBS2026OffroadWheelRear::StaticClass();
